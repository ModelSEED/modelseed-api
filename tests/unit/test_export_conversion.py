"""Unit tests for export_service._model_obj_to_cobra — validates cobra.Model fields."""
...
from modelseed_api.services.export_service import _model_obj_to_cobra  # noqa: E402


class TestWorkspaceModelToCobra:
    def test_compartments_present(self, minimal_model_obj):
        model = _model_obj_to_cobra(minimal_model_obj)
    ...
    def test_model_id(self, minimal_model_obj):
        model = _model_obj_to_cobra(minimal_model_obj, model_id="my_model")
