...
Uses KBUtilLib/ModelSEEDpy to gapfill a metabolic model.
...
def main():
    ...
    try:
        # TODO: Implement gapfilling using MSGapfill
        raise NotImplementedError("Gapfilling not yet integrated with KBUtilLib")
